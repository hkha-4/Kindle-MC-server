...
| **PW5 11th Gen and Newer** | Firmware **5.16.2.1.1 and older** | Soft Float | `bareiron_modern_soft` |
| **PW5 11th Gen and Newer** | Firmware **5.16.3 and newer** | Hard Float | `bareiron_modernhf` |
